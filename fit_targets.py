...
# https://iopscience.iop.org/article/10.3847/1538-4357/aa8e99/pdf
WXCha = FitObject("WX Cha",
                  np.array([4.5, 6, 11, 19, 35, 186, 320,
                            432, 450, 450, 430, 400, 400, 440,
                            370, 420, 410, 390, 330, 220,
                            180, 120, 100, 110, 120, 21]) * 1e-3,
                  np.array([0.9, 1, 2, 4, 4, 5, 10,
                            7, 20, 20, 10, 20, 20,
                            20, 20, 30, 20, 20, 70,
                            40, 40, 20, 20, 20, 20, 2]) * 1e-3,
                  [0.44, 0.48, 0.55, 0.62,
                   0.76, 1.23, 1.66, 2.16,
                   3.6, 4.5, 4.6, 5.8,
                   8.0, 9.0, 12, 18,
                   22, 24, 70, 100,
                   160, 160, 250, 350, 500, 887
                   ],
                  100, True)
